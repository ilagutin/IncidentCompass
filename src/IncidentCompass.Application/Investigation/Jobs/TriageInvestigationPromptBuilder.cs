...
internal static class TriageInvestigationPromptBuilder
{
    ...
    /// <summary>
    /// The fixed task the orchestrator is given after the incident context. The recovery summary
    /// repeats it, without the untrusted context, as the task framing.
    /// </summary>
    ...
    public static string BuildOrchestratorPrompt(TriageJob job, TriageJobInvestigationContext context)
    {
        ...
        builder.AppendLine(OrchestratorTaskInstruction);
