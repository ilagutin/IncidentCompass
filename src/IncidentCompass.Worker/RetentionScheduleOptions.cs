...
/// <summary>
/// Whether this host runs the three retention operations, and how often. It is deliberately separate
...
internal sealed class RetentionScheduleOptions
{
    ...
    /// stop all three operations: the hosted service is still composed and still starts, it simply
    /// runs none of them and says so once, so an operator can tell "retention is switched off" from
